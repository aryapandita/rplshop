                            ...
                            <?php foreach ($all_products as $prod): ?>
                                <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
                                    ...
                                    <td style="padding: 12px 8px;">
                                        <img src="<?= $path_prefix . htmlspecialchars(resolve_product_image_url($prod)) ?>" alt="Cover" style="width:40px; height:40px; border-radius:6px; object-fit:cover; background-color:#0f172a;">
                                    </td>
